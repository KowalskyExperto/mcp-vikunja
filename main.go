...
func main() {
	...
	mcp.AddTool(server, &mcp.Tool{Name: "get_task", Description: "Get the details of a task"}, handler.GetTask)
	mcp.AddTool(server, &mcp.Tool{Name: "update_task", Description: "Update a task"}, handler.UpdateTask)
